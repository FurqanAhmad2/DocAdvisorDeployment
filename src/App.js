...
const socket = socketIO.connect("https://doc-advisor-heroku.herokuapp.com")
    ...
    <div className="">
      ...
      <Routes>
       {/*<Route path="/" element={<PatientDashBoard/>}/>*/}
        <Route path="/PatientDashBoard" element={<PatientDashBoard socket={socket}/>}/>
        <Route path='/DoctorDashBoard' element={<DoctorDashboard socket={socket}/>}/>
